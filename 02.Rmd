...
(ref:02-06) Caco-2 cell-based permeability assay 방법 [@everythingadme]
...
|                |               | cells         |               |
+----------------+---------------+---------------+---------------+
| **Cell         | not applicable| Intestinal    | Distal tubule |
| morphology**   |               | epithelium    | epithelium    |
+----------------+---------------+---------------+---------------+
| **Cell growing | not applicable| \> 21 days    | 3\~4 days     |
| time**         |               |               |               |
+----------------+---------------+---------------+---------------+
| **Permeation   | Passive       | Passive       | Passive       |
| mechanisms**   | diffusion     | diffusion,    | diffusion,    |
|                |               | Active        | Active        |
|                |               | transport,    | transport,    |
|                |               |               |               |
|                |               | Paracellular  | Paracellular  |
|                |               | and Efflux    | and Efflux    |
+----------------+---------------+---------------+---------------+
| **Direction of | One-way       | Bi-           | Bi-           |
| transport**    |               | directional   | directional   |
|                | (Donor →      |               |               |
|                | Acceptor)     | (Apical ↔     | (Apical ↔     |
...
(ref:02-08) Caco-2 투과도와 사람 소장 흡수율 간의 상관 관계 [@everythingadme]
