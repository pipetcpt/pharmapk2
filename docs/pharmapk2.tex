...
\urlstyle{same}
\hypersetup{
  pdfauthor={가톨릭대학교 계량약리학연구소(PIPET), AIMS BioScience v0.2 (2023-10-16)},
  colorlinks=true,
  linkcolor={Maroon},
  filecolor={Maroon},
  citecolor={Blue},
...
\caption{약물의 흡수 과정 (\protect\hyperlink{ref-di2015drug}{Di and Kerns 2015})}\label{fig:figure-first}
\end{figure}
...
\caption{Biopharmaceutics Classification System (BCS) (\protect\hyperlink{ref-lubrizol}{Lubrizol Life Science 2019})}\label{fig:01-02}
\end{figure}
...
\caption{Kinetic solubility 측정법 모식도 (\protect\hyperlink{ref-everythingadme}{Cyprotex 2022})}\label{fig:01-03}
\end{figure}
...
\caption{\label{tab:table01-05} Kinetic solubility의 침전을 검출하는 방법 (\protect\hyperlink{ref-di2015drug}{Di and Kerns 2015})}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Nephelometry
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\caption{Thermodynamic solubility 측정법 모식도 (\protect\hyperlink{ref-everythingadme}{Cyprotex 2022})}\label{fig:01-04}
\end{figure}
...
\caption{Kinetic solubility와 Thermodynamic solubility의 비교 (\protect\hyperlink{ref-alskar2018improved}{Alskar 2018})}\label{fig:01-05}
\end{figure}
...
\hypertarget{uxd22cuxacfcuxb3c4-uxd3c9uxac00}{%
\section{투과도 평가}\label{uxd22cuxacfcuxb3c4-uxd3c9uxac00}}

\hypertarget{pampaparallel-artificial-membrane-permeability-assay}{%
...
\caption{Caco-2 cell-based permeability assay 방법 (\protect\hyperlink{ref-everythingadme}{Cyprotex 2022})}\label{fig:02-06}
\end{figure}
...
\caption{Caco-2 투과도와 사람 소장 흡수율 간의 상관 관계 (\protect\hyperlink{ref-everythingadme}{Cyprotex 2022})}\label{fig:02-08}
\end{figure}
...
\caption{한여과 (ultrafiltration) 평가법 (\protect\hyperlink{ref-everythingadme}{Cyprotex 2022})}\label{fig:03-03}
\end{figure}
...
\hypertarget{uxb192uxc740-uxd608uxc7a5uxb2e8uxbc31uxacb0uxd569uxc728uxc744-uxac00uxc9c4-uxc57duxbb3cuxc758-uxd608uxc7a5uxb2e8uxbc31uxacb0uxd569-uxd3c9uxac00uxbc29uxbc95}{%
...
있다 (\protect\hyperlink{ref-studies2020cytochrome}{In Vitro Drug Interaction Studies 2020}; \protect\hyperlink{ref-european2012guideline}{European Medicines Agency 2012}).
...
Aliphatic hydroxylation & \includegraphics{./media-04/image3.png} \includegraphics{./media-04/image4.png} & Barbiturates, cyclosporine, ibuprofen \\
...
\endlastfoot
I.
Glucuronidation & \includegraphics{./media-04/image15.png}
\includegraphics{./media-04/image16.png} & Diazepam,
digoxin,
acetaminophen,
SN-38, efavirenz \\
II. Acetylation & \includegraphics{./media-04/image17.png}
\includegraphics{./media-04/image18.png} & Isoniazid,
sulfonamide \\
III. Sulfation & \includegraphics{./media-04/image19.png} & Methyldopa \\
IV. Glutathione
conjugation & \includegraphics{./media-04/image20.png} & Acetaminophen,
valproic acid,
busulfan \\
\end{longtable}
...
\hypertarget{uxc2e0uxc57d-uxac1cuxbc1c-uxc8fcuxae30-uxc548uxc5d0uxc11cuxc758-in-vitro-inhibition-assayuxc758-uxc911uxc694uxc131-uxbc0f-uxd65cuxc6a9}{%
...
\ref{fig:05-19})(\protect\hyperlink{ref-cayen2011early}{Cayen 2011})
...
\caption{신약 개발 주기에 따른 in vitro DDI 평가(\protect\hyperlink{ref-li2008drug}{Li 2008})}\label{fig:05-02}
\end{figure}
...
FDA에서 확인하기를 권고하는 주요 CYP isoform 은 7가지로 아래와 같다: CYP1A2, CYP2B6, CYP2C8, CYP2C9, CYP2C19, CYP2D6, CYP3A

대사 억제 작용의 종류는 크게 두가지로 나눌 수 있으며, 가역적 억제는 direct inhibition이라고도 불리우며,억제제-효소가 약하게 결합한 경우로, 빠른 시간 내에 분리가 일어난다. 그리고 바로 효소 활성이 회복된다. 가역적 억제는 억제제와 대사 효소의 결합 양상에 따라 여러 종류로 아래와 같이 세분화될 수 있다.(그림 \ref{fig:05-03}) (그림 \ref{fig:05-20})(\protect\hyperlink{ref-li2008drug}{Li 2008})
...
후보물질의 대사 억제 특성을 평가하기 위해서 각 억제 종류 (가역적 억제 vs.~시간 의존적 억제)에 따라 핵심 in vitro assay를 수행하여 핵심 억제 파라미터를 구해야 한다.

우선, 가역적 억제의 경우 핵심 assay 로는 IC\textsubscript{50} 와 K\textsubscript{i}를 결정하는 시험들이 중요하다.(IC\textsubscript{50}: drug concentration achieving 50\% of maximal reversible inhibition, K\textsubscript{i}: reversible inhibition constant) 시간 의존적 억제 관련 assay로는 Single point assay, IC\textsubscript{50} shift assay, 그리고 K\textsubscript{inact}, K\textsubscript{I}를 결정하는 assay가 중요하다(K\textsubscript{inact}: drug concentration achieving 50\% of maximal inhibition of TDI, KI: TDI constant).
이와 같은 핵심 inhibition assay를 수행하기 전에 무엇보다 우선적으로 수행되어야 하는 것은 substrate saturation experiment(또는 metabolic stability test)이다.
이를 통해 기질의 enzyme kinetic parameter(K\textsubscript{m}, V\textsubscript{max})를 구할 수 있고 intrinsic clearance(CL\textsubscript{int})를 구할 수 있으며(이는 억제제가 없는 조건, in absence of inhibitor), 이때 얻은 K\textsubscript{m} 값을 참고하여 in vitro inhibition assay에서 사용할 적합한 기질의 농도를 설정할 수 있다.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{media-05/image4} 

}

\caption{Michaelis-Menton kinetics of typical enzyme-catalyzed reaction of one substrate Substrate saturation experiment results for enzyme kinetic parameters(V\textsubscript{max}, K\textsubscript{m}), plotting reaction rate vs substrate concentration. V\textsubscript{max}: Maximum reaction rate at saturating substrate concentration for a given enzyme concentration, K\textsubscript{m}: Substrate concentration at half-maximum reaction rate(V\textsubscript{max}), also known as Micahelis constant.}\label{fig:05-03}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{media-05/image20} 

}

\caption{Lineweaver-Burk plots for enzyme inhibition(\protect\hyperlink{ref-linearweaver}{Wikipedia 2023}). 위의 그림은 Michaelis-Menton plot(그림 \ref{fig:05-03})의 역수이며, 속도의 역수(1/V)에 대한 기질 농도의 역수(1/{[}S{]})의 비율을 나타냄}\label{fig:05-20}
\end{figure}



Mechanism-based inhibition (MBI)은 흔히 시간 의존적 억제(time-dependent
inhibition,TDI) 라고도 불리우나, TDI가 조금 더 큰 범주라고 할 수 있다. TDI은 preincubation 시간을 거치면서 억제 효능(inhibition potency)이 더 좋아지는 경우를 일컬으며, MBI는 TDI의 한 종류로 볼 수 있다. MBI에서는 억제제와 enzyme 이 결합하여 reactive metabolite을 생성하고, 대사 효소가 활성을 잃고 비활성(inactive) 상태로 변한다. 따라서 이를 비가역성 억제(irreversible inhibition)라고도 부른다.

\hypertarget{uxb300uxc0ac-uxc5b5uxc81c-uxd2b9uxc131-uxd3c9uxac00-uxc2e4uxd5d8-in-vitro-inhibition-assay-1}{%
...
후보물질의 대사 억제 특성을 평가하기 위해서 각 억제 종류 (가역적 억제 vs.~시간 의존적 억제)에 따라 핵심 in vitro assay를 수행하여 핵심 억제 파라미터를 구해야 한다. 우선, 가역적 억제의 경우 핵심 assay 로는 IC\textsubscript{50} 와 K\textsubscript{i}를 결정하는 시험들이 중요하다.(IC\textsubscript{50}: drug concentration achieving 50\% of maximal reversible inhibition, K\textsubscript{i}: reversible inhibition constant) 시간 의존적 억제 관련 assay로는 Single point assay, IC\textsubscript{50} shift assay, 그리고 K\textsubscript{inact}, K\textsubscript{I}를 결정하는 assay가 중요하다(K\textsubscript{inact}: drug concentration achieving 50\% of maximal inhibition of TDI, KI: TDI constant).
...
{\centering \includegraphics[width=1\linewidth]{media-05/image5} 

}

\caption{Metabolite formation depending on the various inhibitor concentration (\protect\hyperlink{ref-invitroadme}{Cyprotex 2023})}\label{fig:05-04}
\end{figure}



\begin{longtable}[]{@{}ll@{}}
\caption{\label{tab:interpretic50} Interpretation of IC50 values (\protect\hyperlink{ref-invitroadme}{Cyprotex 2023})}\tabularnewline
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
Potent inhibition & IC\textsubscript{50} \textless{} 1uM \\
Moderate inhibition & IC\textsubscript{50} between 1 and 10uM \\
No or weak inhibition & IC\textsubscript{50} \textgreater{} 10uM \\
\end{longtable}

\hypertarget{cyp-inhibition-assay-for-ki-determination}{%
...
실험은 다양한 기질과 억제제농도로 수행된다. 아래와 같이 다양한 억제제 농도에 따른 반응속도(velocity)와 기질농도({[}S{]})의 그래프를 얻을 수 있다.(그림 \ref{fig:reactionrate}) 그래프의 양상을 통해 가역적 억제의 종류를 알아낼 수 있다(i.e.~competitive, noncompetitive, uncompetitive, or mixed).
K\textsubscript{i}를 구하는 방법은 여러가지로, regression을 통해서 Rate equation 식에 fitting 한 후 K\textsubscript{i}를 값을 계산하여 얻을 수 있다(표 \ref{tab:rateequation}). 또는, 얻어진 IC\textsubscript{50} 값을 기반으로 간단하게 계산하는 방법이 있다. 1차식에 의한
대사(first-order kinetic) 가 가장 잘 관측되는 구간은 기질의 농도가 K\textsubscript{m}
값과 비슷하거나 작을 때이며, 따라서 대부분의 경우 Ki 값은 IC\textsubscript{50} 와
유사하거나, IC\textsubscript{50}/2 로 계산할 수 있다(수식 \eqref{eq:estimki}).
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5000}}@{}}
\caption{\label{tab:rateequation} Rate equations for different inhibition model types.(\protect\hyperlink{ref-invitroadme}{Cyprotex 2023}) V\textsubscript{max} : Maximal rate, K\textsubscript{m} : Affinity constant, {[}S{]} : Substrance concentration, {[}I{]}: Inhibitor concentration, K\textsubscript{i} : Inhibition contant, \(\alpha\) : Interaction parameter which determines the degree to which the binding of inhibitor changes the affinity of the enzyme of the substrate}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Inhibition type
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{time-dependent-inhibition-assay}{%
...
\hypertarget{cyp-tdi-assay-for-ic50-shift-determination}{%
...
이때 얻어지는 그래프는 억제제 농도에 따른 \%CYP 활성이며, NADPH를 포함하여 preincubation 한 경우의 IC\textsubscript{50} 가 약 1.5배 작아지면(left shift of IC\textsubscript{50}), 해당 약물은 TDI을 나타내는 것으로 해석될 수 있다.(\protect\hyperlink{ref-invitroadme}{Cyprotex 2023}) 다만, 해당 수치적 기준은 명확하게 수립된 바는 없으며 IC\textsubscript{50} shift가 대략 2.5-3배 이상이면 TDI를 나타내는 것으로 보기도 한다. 이와 같은 IC\textsubscript{50} 값의 left shift는 preincubation을 통해 CYP 활성을 억제하는 능력이 커짐을 의미한다.
...
\caption{Example of IC50 shift profile of \%CYP activity vs.~inhibitor concentration plus/minus NADPH during preincubation period(\protect\hyperlink{ref-invitroadme}{Cyprotex 2023})}\label{fig:IC50shift}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{media-05/examples-3fig} 

}

\caption{(a) Example of (a) \%CYP activity remaining vs.~preincubation time, (b) -slope (of (a) graph) vs.~inhibitor concentration or Observed rate (Kobs) model, (c) Linewever-Burk plot, x-intercept: 1/KI, y-intercept: 1/Kinact (\protect\hyperlink{ref-li2008drug}{Li 2008})}\label{fig:05-21}
\end{figure}
...
\hypertarget{uxd6c4uxbcf4-uxbb3cuxc9c8uxc758-uxc720uxb3c4-uxac00uxb2a5-uxc5ecuxbd80-uxd3c9uxac00uxb97c-uxc704uxd55c-study-uxb514uxc790uxc778}{%
...
\hypertarget{in-vitro-study-uxb514uxc790uxc778}{%
...
\hypertarget{in-vivo-study-uxb514uxc790uxc778}{%
...
\hypertarget{uxd6c4uxbcf4-uxbb3cuxc9c8uxc758-uxc720uxb3c4-uxac00uxb2a5uxc131-uxd3c9uxac00}{%
...
\hypertarget{basic-kinetic-model}{%
...
살펴보자. (\protect\hyperlink{ref-varma2015predicting}{M. V. Varma et al. 2015})
...
(\protect\hyperlink{ref-wang2008oct2}{Wang et al. 2008}) (그림 \ref{fig:07-09})
...
cimetidine의 신장에서의 약물상호작용 기전 (\protect\hyperlink{ref-burt2016metformin}{Burt et al. 2016}) (좌)와
metformin의 cimetidine 병용에 따른 혈중농도 프로파일 변화
(\protect\hyperlink{ref-wang2008oct2}{Wang et al. 2008}) (우)}\label{fig:07-09}
\end{figure}
...
\caption{Sandwich-cultured hepatocytes (\protect\hyperlink{ref-brouwer2013vitro}{Brouwer et al. 2013})}\label{fig:07-13}
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-alskar2018improved}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-grimm2009conduct}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-li2008drug}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lubrizol}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-varma2017extended}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-linearweaver}{}}%
