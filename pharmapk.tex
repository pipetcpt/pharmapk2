...
\caption{Metformin -- cimetidine 약물상호작용. Metformin -- cimetidine의 신장에서의 약물상호작용 기전 (\protect\hyperlink{ref-burt2016metformin}{Burt et al. 2016}) (좌)와 metformin의 cimetidine 병용에 따른 혈중농도 프로파일 변화 (\protect\hyperlink{ref-wang2007oct2}{\textbf{wang2007oct2?}}) (우)}\label{fig:07-09}
\end{figure}
