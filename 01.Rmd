...
Table: (\#tab:table01-01) NCA와 구획모델 분석으로 얻어지는 PK 파라미터 비교
...
표 5. Kinetic solubility의 침전을 검출하는 방법
  ...
  ----------------------------------------------------- ------------------------------------------------------ ---------------------------------------
  ![](./media-01/image4.png){width="1.886142825896763in"   ![](./media-01/image5.png){width="1.7580161854768155in"   ![](./media-01/image6.png){width="2.0in"
